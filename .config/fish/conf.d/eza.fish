...
complete -c eza        -l 'color'        -d "When to use terminal colours"
complete -c eza        -l 'colour'       -d "When to use terminal colours"
complete -c eza        -l 'color-scale'  -d "Highlight levels of file sizes distinctly"
complete -c eza        -l 'colour-scale' -d "Highlight levels of file sizes distinctly"
...
complete -c eza -s 'L' -l 'level'     -d "Limit the depth of recursion" -a "1 2 3 4 5 6 7 8 9"
complete -c eza -s 'r' -l 'reverse'   -d "Reverse the sort order"
complete -c eza -s 's' -l 'sort'   -x -d "Which field to sort by" -a "
...
complete -c eza -s 'g' -l 'group'    -d "List each file's inode number"
complete -c eza -s 'S' -l 'blocks'   -d "List each file's number of filesystem blocks"
complete -c eza -s 't' -l 'time'  -x -d "Which timestamp field to list" -a "
...
complete -c eza        -l 'time-style' -x -d "How to format timestamps" -a "
