# buildah
# Autogenerated from man page /usr/share/man/man1/buildah.1.gz
complete -c buildah -l cgroup-manager -d 'The CGroup manager to use for container cgroups'
...
complete -c buildah -l short-name-alias-conf -d 'Pathname of the file which contains cached mappings between short image names…'
